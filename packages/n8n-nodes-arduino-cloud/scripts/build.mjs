...
// (Arduino Cloud SDKs, MQTT client, shared helpers) is bundled into each
// output file so the published package is self-contained and doesn't need
// node_modules in custom/.
const shared = {
  bundle: true,
  platform: 'node',
  target: 'node20',
